        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }} className="max-w-3xl">
            <div className="inline-flex items-center gap-3 mb-5">
              ...
              <span className="font-archivo font-semibold text-gold text-[11px] tracking-[0.16em] uppercase">Our Solutions - 10 Pillars</span>
            </div>
            ...
            <p className="mt-4 text-white/70 text-[14px] md:text-[15px] leading-[1.6] max-w-xl font-medium">Construction & affordable housing, frameless & aluminium glass, procurement & logistics (PPA-registered), plumbing, electrical, water, carpentry, tree cutting and rubbish & recycling - tailored, transparent and technology-driven.</p>
          </motion.div>
        </div>
      </section>
